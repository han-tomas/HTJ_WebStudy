...
<body>
	...
	<table class="table">
		...
		<tr>
			<td colspan=2>
				<pre> 
 public void _jspService(<mark>HttpServletRequest request, HttpServletResponse response</mark>)
 {
	  ...
	  Jsp 코딩영역
		...
		<tr>
			<td colspan=2>
				...
				<li>JSP 파일에서 서블릿 관련 객체</li>
				<li>JSP 파일에서 예외관련 객체</li>
				</ul>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td width=25%>out</td>
			<td width=75%>출력 버퍼와 관련<br>
			<sub>출력버퍼: 실행된 HTML을 저장하는 공간(브라우저에서 읽어가는 공간)</sub>
			</td>
