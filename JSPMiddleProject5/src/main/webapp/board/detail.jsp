...
<%
	...
	/*
		board.jsp
			=> 새글 -> insert.jsp => insert_ok.jsp =>board.jsp
			=> 상세보기
			detail.jsp
				=> 답변  -> reply.jsp -> reply_ok.jsp -> board.jsp
				=> 수정	-> update.jsp => update_ok.jsp =>detail.jsp
				=> 삭제	-> delete.jsp => delete_ok.jsp => borad.jsp
				=> 목록	-> board.jsp
	*/
%>
<!DOCTYPE html>
		...
		<div class="row">
			<table class="table">
				...
				<tr>
					...
					<pre style="white-space: pre-wrap;border:none;backgroud_color:white">${vo.content }</pre>
					</td>
				</tr>
				<tr>
					<td colspan="4" class="text-right">
						...
						<a href="board.jsp" class="btn btn-xs btn-danger">목록</a>
					</td>
				</tr>
			</table>
		</div>
