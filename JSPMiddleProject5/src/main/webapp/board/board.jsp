...
<%
	...
	request.setAttribute("curpage", curpage); //<c:set var="curpage" value="<%=curpage ~
		...
		<div class="row">
			...
			<table class="table">
				...
				<c:forEach var="vo" items="${list }">
					<tr>
						<th width=10% class="text-center">${count }</td>
						<td width=45% >
			...
			<table class="table">
				<tr>
					...
					<td class="text-right">
						<a href="board.jsp?page=${curpage>1?curpage-1:curpage }" class="btn btn-sm btn-info">&lt;</a>
							${curpage} page/${totalpage }pages
						<a href="board.jsp?page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-sm btn-warning">&gt;</a>
					</td>
				</tr>
			</table>
		</div>
