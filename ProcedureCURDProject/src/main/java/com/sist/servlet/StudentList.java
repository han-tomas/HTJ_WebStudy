...
public class StudentList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(".ros{margin:0px auto;width:700px;}");
	    ...
	    out.println("<tr>");
	    out.println("<td>");
	    out.println("<a href=StudentInsert class=\"btn btn-xs btn-success\">등록</a>&nbsp;");
	    out.println("</td>");
	    out.println("</tr>");
	    out.println("</table>");
		out.println("<table class=table>");
		...
		for(StudentVO vo:list)
		{
			...
			out.println("<a href=StudentUpdate?hakbun="+vo.getHakbun()+" class=\"btn btn-sm btn-primary\">수정</a>&nbsp");
			out.println("<a href=StudentDelete?hakbun="+vo.getHakbun()+" class=\"btn btn-sm btn-info\">삭제</a>&nbsp");
			out.println("</td>");
			out.println("</tr>");
		}
		out.println("<table>");
