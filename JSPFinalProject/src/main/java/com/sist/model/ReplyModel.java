...
public class ReplyModel {
	...
	public String reply_update(HttpServletRequest request, HttpServletResponse response)
	{
		...
		String no = request.getParameter("no"); // 참조용
		String type = request.getParameter("type"); // 페이지 이동용
		String cno = request.getParameter("cno"); // 페이지 이동용
		String msg = request.getParameter("msg");// 수정할 내용
		// 기능처리
		ReplyDAO dao = ReplyDAO.newInstance();
