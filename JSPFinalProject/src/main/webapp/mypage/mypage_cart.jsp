...
IMP.init("imp45727200"); // 예: imp00000000
function requestPay() {
	console.log('clicked');
...
<h2 class="sectiontitle">${sessionScope.name }님의 장바구니 목록</h2>
	<table class="table">
		...
		<c:forEach var="vo" items="${list }">
			<tr>
				<th class="text-center">${vo.cart_no }</th>
				...
				<td class="text-center">
						<input type=button value="구매" id="byBtn" data-no="${vo.cart_no }" class="btn btn-sm btn-success">
						<a href="../mypage/cart_cancel.do?no=${vo.cart_no }" class="btn btn-sm btn-danger">취소</a>
				</td>
			</tr>
		</c:forEach>		
	</table>
