...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e8b4b325790b198b8b1a3a75d3ccaa60&libraries=services"></script>
<style type="text/css">
.container{
	margin-top: 50px;
}
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-5">
				<table class="table">
				<tr>
					<td class="text-center"><h3>주변 맛집</h3></td>
				</tr>
				</table>
