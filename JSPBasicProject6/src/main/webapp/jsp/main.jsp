 ...
 ***2) 세션 저장 기간
		session.setMaxInactiveInterval() => 30분(1800초)
 ***3) 세션 읽기
 ...
 ***5) 세션 전체 삭제
 ...
 <%
 	...
 	if(cookies!=null) // 쿠키가 존재하면
 	{
 		...
 		{
 			if(cookies[i].getName().startsWith("food_")) // "food_"+fno
 			{
 				String fno=cookies[i].getValue(); //fno
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="text-center">
				<a href="main.jsp?page=<%=curpage>1?curpage-1:curpage %>" class="btn btn-sm btn-danger">&lt;</a>
					<%= curpage %> page/ <%=totalpage %> pages
				<a href="main.jsp?page=<%=curpage<totalpage?curpage+1:curpage %>" class="btn btn-sm btn-primary">&gt;</a>
			</div>
		</div>
		<div style="height:20px"></div>
		<h3>최신 방문 맛집</h3>
		...
		<div class="row">
			...
			%>
						<td>
						<img src="<%=vo.getPoster() %>" style="width:100px; heigth:100px" title="<%=vo.getName() %>"> 
						<p>
